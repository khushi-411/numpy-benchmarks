...
from bench_more_opti import transonic_boost
...
def main(_time_step, _number_of_steps, _iterations, _masses, _positions, _velocities):
    ...
    for loop in (pythran, numba, pythran_naive, numpy_highlevel, pure_numpy_highlevel, transonic_boost):
        t = 0
...
if __name__ == "__main__":
    ...
    #    _file_path = "/mnt/c/Users/khush/Documents/Quansight-Intern/pierre/input"+str(i)
    #    _masses, _positions, _velocities = load_input_data(_file_path)
    #    _time = main(_time_step, _number_of_steps, _masses, _positions, _velocities)
