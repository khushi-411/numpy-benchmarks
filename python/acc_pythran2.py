...
def compute_accelerations(accelerations, masses, positions):
    ...
    for index_p0 in range(nb_particles - 1):
        ...
        ind0_div = ind0_div.T
        ind0_sum = np.sum(ind0_div, axis = 0)
        accelerations[index_p0] += accelerations[index_p0]

        ind1_mul = mass0 * vectors.T
        ind1_div = ind1_mul / coefs
        ind1_div = ind1_div.T
        accelerations[index_p0 + 1: nb_particles] += ind1_div
