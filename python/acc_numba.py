...
if __name__ == "__main__":
    ...
    start = time.time()
    for i in range(5):
        energy, energy0 = numba_loop(time_step, nb_steps, masses, positions, velocities)
    end = time.time()
    
    print("Time taken: ", (end - start)/5)

    print(f"Final dE/E = {(energy - energy0) / (energy0 + 1e+314):.7e}")
    print(
